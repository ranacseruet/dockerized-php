<form action="{$base_url}message/delete" method="POST">
        ...
        <tbody>
            ...
            {foreach from=$messages item=message name="outer"}
                <tr>
                    ...
                    <td> <a href="{$base_url}message/edit/{$message->getId()}">View/Edit</a> </td>
                </tr>
            {/foreach}
...
<a href="{$base_url}message/add" class="btn btn-success">Ad New</a>
</div>
</form>