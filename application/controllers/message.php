...
class Message extends MY_Controller
{
    ...
    public function index($start_record=0)
    {
        try
        {
            $pagingConfig   = $this->paginationlib->initPagination("/message/index",$this->messagemodel->get_count());
    ...
    public function edit($id)
    {
        ...
        try
        {
            ...
            $this->data["action_url"] = base_url()."message/edit/".$id;
    ...
    public function add()
    {
        ...
        try
        {
            ...
            $this->data["action_url"] = base_url()."message/add";
...
/* Location: ./application/modules/controllers/message.php */
